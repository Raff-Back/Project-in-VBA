...
Private Sub Botao_Cadastrar_Click()
    ...
    If fornecedor > 0 Then
        MsgBox "Fonecedor ja foi cadastrado!", vbCritical, "ATENÇÃO!"
        Exit Sub
    End If
    ...
    strPath = "C:\Users\" & user & "\Desktop\" & Caixa_NomeFornecedor & ".xlsx"
    ...
    If strCheck = False Then
        ...
        ActiveSheet.Copy
        With ActiveWorkbook
        .SaveAs "C:\Users\" & user & "\Desktop\" & nome & ".xlsx"
        ActiveWorkbook.Close
        End With
        MsgBox "Arquivo '" & nome & " enviados.xlsx' criado em area de trabalho.", vbInformation, "ATENÇÃO!"
    End If
...
Private Sub Caixa_NomeFornecedor_Change()
    ...
    Caixa_NomeFornecedor.MaxLength = 30
